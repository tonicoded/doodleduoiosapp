  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-16 space-y-8 text-[#3a2c2b]">
      ...
      <section className="space-y-4">
        ...
        <p>
          Our marketing site logs anonymous visit counts so we know how many people are excited about the beta. When you
          join the waitlist we store the email address you provide plus optional referral info so we can send invite
          waves. You can opt out at any time by emailing us.
        </p>
      </section>
